                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <div className="flex gap-3 md:gap-4 mt-6">
                            <a href="#" className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white flex items-center justify-center text-[#4b2e19] hover:bg-[#4b2e19] hover:text-[#f5d26a] hover:-translate-y-1 transition-all duration-300 shadow-sm border border-[#4b2e19]/10" aria-label="Facebook">
                                <svg className="w-[18px] h-[18px] fill-current" viewBox="0 0 24 24">
                                    <path d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.14-2.857-.14C11.928 2 10 3.657 10 6.7v2.8H7v4h3V22h4v-8.5z"/>
                                </svg>
                            </a>
                            <a href="#" className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white flex items-center justify-center text-[#4b2e19] hover:bg-[#4b2e19] hover:text-[#f5d26a] hover:-translate-y-1 transition-all duration-300 shadow-sm border border-[#4b2e19]/10" aria-label="Instagram">
                                <svg className="w-[18px] h-[18px] fill-current" viewBox="0 0 24 24">
                            ...
                            <a href="#" className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white flex items-center justify-center text-[#4b2e19] hover:bg-[#4b2e19] hover:text-[#f5d26a] hover:-translate-y-1 transition-all duration-300 shadow-sm border border-[#4b2e19]/10" aria-label="Twitter">
                                <svg className="w-[16px] h-[16px] fill-current" viewBox="0 0 24 24">
                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                                </svg>
                            </a>
                            <a href="#" className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white flex items-center justify-center text-[#4b2e19] hover:bg-[#4b2e19] hover:text-[#f5d26a] hover:-translate-y-1 transition-all duration-300 shadow-sm border border-[#4b2e19]/10" aria-label="YouTube">
                                <svg className="w-[18px] h-[18px] fill-current" viewBox="0 0 24 24">
